...
call our new fix_insert method with the new node at the very end of what you've written so far.
We've already written the rotation functions, so the fix_insert method is just responsible for recoloring the nodes, and calling the rotation methods as necessary.
